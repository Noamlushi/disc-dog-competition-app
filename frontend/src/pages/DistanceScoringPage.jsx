        ...
        <div className="min-h-screen bg-gray-50">
                ...
                <div className="container mx-auto px-4 py-4">
                    ...
                    <div className="flex items-center justify-center gap-8">
                        <div className="text-center">
                            <div className="text-sm text-gray-500 font-semibold mb-1">Final Score</div>
                            <div className="text-5xl font-black text-blue-900">
                                {finalScore.toFixed(1)}
                                <span className="text-2xl text-gray-400 font-normal"> / 25.0</span>
                            </div>
                        </div>
                        <div className="text-center">
                            <div className="text-sm text-gray-500 font-semibold mb-1">Attempts</div>
                            <div className="text-5xl font-black text-gray-700">{totalCatches}</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="container mx-auto px-4 py-8 max-w-4xl">
                ...
                <div className="space-y-3 mb-8">
                    <div className="text-center text-sm text-gray-500 font-semibold mb-2">← Far</div>
                    ...
                    <div className="text-center text-sm text-gray-500 font-semibold mt-2">Near (Throwing Line) →</div>

                    {/* Miss and Foot Fault Buttons */}
                    <div className="grid grid-cols-2 gap-4 mt-6 pt-6 border-t-2 border-gray-300">
                        <button
                            onClick={() => {
                                const newAttempt = {
                                    id: Date.now(),
                            ...
                            className="py-6 rounded-xl text-2xl font-bold bg-gradient-to-r from-gray-300 to-gray-400 text-gray-700 shadow-lg transition-all transform hover:scale-[1.02] active:scale-[0.98]"
                        >
                            Miss (0 pts)
                        </button>
                        <button
                ...
                <div className="bg-white rounded-xl shadow-md p-6 mb-6">
                    <h3 className="text-xl font-bold text-gray-800 mb-4 flex items-center justify-between">
                        ...
                        <span className="bg-blue-900 text-white px-4 py-1 rounded-full text-sm">{attempts.length}</span>
                    </h3>
                            ...
                            {attempts.map((attempt, idx) => (
                                ...
                                >
                                    <div className="flex items-center gap-4">
                                        <span className="text-gray-400 font-mono font-bold text-sm bg-white px-2 py-1 rounded border">
                                            #{idx + 1}
                                        </span>
                                        <div className="flex items-center gap-2">
                                            {attempt.isFootFault ? (
                                                <span className="font-bold text-red-600">Foot Fault</span>
                                            ) : attempt.zone === 0 ? (
                                                <span className="font-bold text-gray-500">Miss</span>
                                            ) : (
                                                <>
                                                    <span className="font-bold text-gray-700">Zone {attempt.zone}</span>
                                                    {attempt.jump && <span className="bg-blue-100 text-blue-700 px-2 py-0.5 rounded text-xs font-semibold">Airborne</span>}
                                                    {attempt.bonusZone && <span className="bg-orange-100 text-orange-700 px-2 py-0.5 rounded text-xs font-semibold">Bonus</span>}
                                                </>
                                            )}
                                        </div>
                                    </div>
